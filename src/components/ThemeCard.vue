      ...
      <div class="grid grid-cols-1 @lg:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <textarea
            ...
            maxlength="250"
            class="w-full text-sm rounded-md border border-input bg-card px-3 py-2 ring-offset-background placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-none"
            rows="3"
          ></textarea>
        </div>
      </div>
